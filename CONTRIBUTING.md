# Contributing to usdb_downloader

Thank you for your interest in contributing to usdb_downloader! We welcome community contributions to help improve
the package.
...
4. **Add tests**: If you’ve fixed a bug or added new functionality, please include tests.
5. **Run tests**: Ensure the test suite passes before submitting your PR.
6. **Format and analyze your code**: Use tools like `make fix_style` to format your code and check for issues.
7. **Create the pull request**: Submit your PR and include a detailed description of the changes made.
8. **Verify status checks**: Ensure all status checks are passing before finalizing your PR.
...
- **Application version**: Specify the version of the affected application where you encountered the bug. This helps us understand
...
By contributing to usdb_downloader, you agree that your contributions will be licensed under
